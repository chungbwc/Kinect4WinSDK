	...
	(JNIEnv* env, jobject obj)
{
	...
	cls = env->GetObjectClass(obj);
	fid = env->GetFieldID(cls, "ptr", "J");
	kinect = (Kinect4WinSDK *) env->GetLongField(obj, fid);
	...
	(JNIEnv* env, jobject obj)
{
	...
	kinect = (Kinect4WinSDK *) env->GetLongField(obj, fid1);
